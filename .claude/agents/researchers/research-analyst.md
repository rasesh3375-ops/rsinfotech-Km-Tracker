...
- **Each one must remove real, repeated work.** "An agent that summarizes
  articles" is a demo. "An agent that reads the deploy log every Friday and flags
  releases that shipped without a passing test run" is a tool. If you can't name the
