...
**Build a new agent:**
```
/build-agent I want an agent that summarises yesterday’s failed CI runs
```
...
It was seeded from the session that built this org, so it already knows your
working style, your environment, and what this project is for. Some of that is
inference — fix what's wrong and it stops being wrong.
